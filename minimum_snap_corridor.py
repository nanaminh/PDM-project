...
if __name__ == "__main__":
    ...
    p.addUserDebugLine([0,2,2], [2,2,2], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
    p.addUserDebugLine([2,2,2], [2,-2,2], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
    p.addUserDebugLine([2,-2,2], [0,-2,2], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
   
    # p.addUserDebugLine([0,0,0], [-1,-1,1], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
    # p.addUserDebugLine([-1,-1,1], [1,2,1.5], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
    # p.addUserDebugLine([1,2,1.5], [3,1,2], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
    # p.addUserDebugLine([3,1,2], [1,-1,2.5], lineColorRGB=[0, 1, 0], lifeTime=0, lineWidth=3)
   
   
   
    for wp in range(0,len(TARGET_POS)-20,20):
        p.addUserDebugLine(TARGET_POS[wp], TARGET_POS[wp+20], lineColorRGB=[1, 1, 0], lifeTime=0, lineWidth=2)
    ...
    for wp in range(0,len(TARGET_POS)-20,20):
        p.addUserDebugLine(TARGET_POS[wp], TARGET_POS[wp+20], lineColorRGB=[1, 0, 1], lifeTime=0, lineWidth=2)
