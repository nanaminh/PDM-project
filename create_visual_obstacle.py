...
# useMaximalCoordinates is much faster than the default reduced coordinates (Featherstone)
...
#                       basePosition=[((-range_x / 2) + i) * meshScale[0] * 2,
#                                     (-range_y / 2 + j) * meshScale[1] * 2, 1],
